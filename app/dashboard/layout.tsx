...
const navItems = [
  { href: '/dashboard/overview', label: 'Analitik POS', icon: BarChart3, description: 'Dashboard & Visualisasi CSV' },
  { href: '/dashboard/input-data', label: 'Input Pembelian', icon: ShoppingBag, description: 'Catat pengeluaran bisnis' },
  { href: '/dashboard/database', label: 'Riwayat Pembelian', icon: Receipt, description: 'Database transaksi' },
];
  ...
  return (
    <CSVProvider>
      <div className="flex h-[100dvh] overflow-hidden" style={{ backgroundColor: '#faf9f5' }}>
        ...
        >
          {/* Logo + Collapse Toggle (unified top area) */}
          {collapsed ? (
            <div
        ...
        {/* Talk to Data floating panel — for BOTH CSV and Database */}
        <TalkToDataPanel />
      </div>
    </CSVProvider>
  );
